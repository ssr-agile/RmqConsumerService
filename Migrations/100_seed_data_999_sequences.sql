...
SELECT pg_catalog.setval('{schema}.ax_entity_relseq', 1462, true);
...
SELECT pg_catalog.setval('{schema}.connectnoseq', 132, true);
...
SELECT pg_catalog.setval('{schema}.seq_axdb_recordid', 1, false);
