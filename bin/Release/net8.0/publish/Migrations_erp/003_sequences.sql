...
-- Set table owners first
ALTER TABLE {schema}.ax_homebuild_master OWNER TO {schema};
ALTER TABLE {schema}.ax_homebuild_saved OWNER TO {schema};
ALTER TABLE {schema}.ax_widget OWNER TO {schema};
ALTER TABLE {schema}.axsms OWNER TO {schema};
ALTER TABLE {schema}.inbound OWNER TO {schema};
ALTER TABLE {schema}.outbound OWNER TO {schema};
--------------------------------------

ALTER SEQUENCE {schema}.ax_entity_relseq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_homebuild_master_homebuild_id_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_homebuild_master_homebuild_id_seq OWNED BY {schema}.ax_homebuild_master.homebuild_id;

ALTER SEQUENCE {schema}.ax_homebuild_master_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_homebuild_saved_homebuild_id_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_homebuild_saved_homebuild_id_seq OWNED BY {schema}.ax_homebuild_saved.homebuild_id;

ALTER SEQUENCE {schema}.ax_homebuild_saved_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_layoutdesign_saved_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_layoutdesign_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_notify_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_page_saved_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_page_template_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_pages_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_widg_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_widget_publish_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_widget_saved_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_widget_widget_id_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.ax_widget_widget_id_seq OWNED BY {schema}.ax_widget.widget_id;

ALTER SEQUENCE {schema}.axdsignmail_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.axp_mailjobsid OWNER TO {schema};

ALTER SEQUENCE {schema}.axpdef_genseq OWNER TO {schema};

ALTER SEQUENCE {schema}.axsms_recordid_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.axsms_recordid_seq OWNED BY {schema}.axsms.recordid;

ALTER SEQUENCE {schema}.axsms_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.axsmsid OWNER TO {schema};

ALTER SEQUENCE {schema}.connectnoseq OWNER TO {schema};

ALTER SEQUENCE {schema}.inbound_inboundid_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.inbound_inboundid_seq OWNED BY {schema}.inbound.inboundid;

ALTER SEQUENCE {schema}.inbound_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.outbound_outboundid_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.outbound_outboundid_seq OWNED BY {schema}.outbound.outboundid;

ALTER SEQUENCE {schema}.outbound_seq OWNER TO {schema};

ALTER SEQUENCE {schema}.seq_axdb_recordid OWNER TO {schema};
...
SELECT pg_catalog.setval('{schema}.ax_entity_relseq', 16665, true);
...
SELECT pg_catalog.setval('{schema}.ax_layoutdesign_saved_seq', 108, true);

SELECT pg_catalog.setval('{schema}.ax_layoutdesign_seq', 184, true);
...
SELECT pg_catalog.setval('{schema}.connectnoseq', 4332, true);

SELECT pg_catalog.setval('{schema}.inbound_inboundid_seq', 1028, true);

SELECT pg_catalog.setval('{schema}.inbound_seq', 798, true);

SELECT pg_catalog.setval('{schema}.outbound_outboundid_seq', 1, false);

SELECT pg_catalog.setval('{schema}.outbound_seq', 1, false);

SELECT pg_catalog.setval('{schema}.seq_axdb_recordid', 4, true);
