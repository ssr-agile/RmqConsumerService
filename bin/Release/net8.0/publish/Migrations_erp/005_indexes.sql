...
CREATE INDEX batchandcost_branch_idx ON {schema}.batchandcost USING btree (branch, itemname, docdate, docid, batch);

CREATE INDEX idx_accountsdtl_keyindex ON {schema}.accountsdtl USING btree (accountshdrid, accountname);
